...
public class SettingsHeadingView extends ConstraintLayout {

    @Getter
    @BindView(R.id.heading_description)
    TextView textView;

    public SettingsHeadingView(Context context) {
        super(context);
        init();
    }

    public SettingsHeadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SettingsHeadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    private void init() {
        inflate(getContext(), R.layout.settings_heading, this);
