...
public class ViewHolderTypeImage extends ViewHolderTypeBase {
    ...
    ViewHolderTypeImage(View view, int itemViewType) {
    ...
    public void setCardAttributes(boolean playNonFeatureGifs, Team team, GradientDrawable teamColorGradient, int intPrimaryColor, int intSecondaryColor, String regionBackgroundURL, boolean isLightTeam) {
        ...
        //Included in XML layout: teamview_card_type_base_date1_and_region, populated by team view template.
        f1_standard_player.setVisibility(View.INVISIBLE);
        f1_standard_video_artwork.setVisibility(View.VISIBLE);

        String imageUrl = mItem.getImageAssetUrl();
        f1_standard_video_artwork.loadImage(playNonFeatureGifs, imageUrl, team.getPrimaryColor(), null);

        playhead_icon.setVisibility(View.INVISIBLE);
    ...
    public String toString() {
        return "ViewHolderTypeImage" + title.getText();
    }
}
